...
class MovieModel(Base):
    ...
    status: Mapped[MovieStatusEnum] = mapped_column(
        SQLAlchemyEnum(MovieStatusEnum),
        default=MovieStatusEnum.RELEASED,
        nullable=False,
    )
...
class MovieCommentModel(Base):
    ...
    parent = relationship(
        "MovieCommentModel", back_populates="replies", remote_side=[id]
    )
...
class PurchasedMovieModel(Base):
    ...
    user: Mapped["UserModel"] = relationship(
        "UserModel", back_populates="purchased_movies"
    )
    movie: Mapped["MovieModel"] = relationship(
        "MovieModel", back_populates="purchased_by"
    )
